...
document.querySelectorAll('.skill-card, .project-card, .stat-item, .contact-method').forEach(el => {
    el.style.opacity = '0';
...
console.log('🎵 Welcome to Arthur\'s Portfolio! 🎵');
console.log('Built with ❤️ and lots of CSS magic ✨');